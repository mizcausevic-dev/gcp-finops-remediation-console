...
const PRODUCT = {
  "repo": "gcp-finops-remediation-console",
  "vendor": "GCP",
  "title": "FinOps remediation console",
  "domain": "Cloud / FinOps",
  "audience": "Cloud platform leaders, FinOps teams, engineering managers, and CFO operators",
  "problem": "GCP spend issues are difficult to act on when budget alerts, BigQuery cost, owners, and remediation status live in separate systems.",
  "workflow": "The product routes budget pressure, unlabeled spend, query-cost spikes, and owner gaps into a single remediation posture.",
  "business": "Leaders can distinguish unavoidable cloud investment from waste, leakage, and governance work that should be automated.",
  "technical": "Synthetic FinOps lanes are scored deterministically and published as a static cost-governance proof surface.",
  "integration": "GCP billing exports, BigQuery usage, labels, budgets, owner maps, and remediation tickets.",
  "keywords": [
    "GCP",
    "BigQuery",
    "FinOps",
