...
Board-readable Kinetic Gain proof repo for **GCP** signal coverage.
...
GCP and BigQuery FinOps remediation, budget evidence, spend routing, and ownership posture.

This repo is intentionally small and explicit. It gives the portfolio atlas a named, inspectable proof artifact for GCP without needing another hosted subdomain or exposing live customer data.
